...
def save_dataset_info(output_dir, color_to_class, class_names, mean, std, class_counts, target_size):
...
def main():
    ...
    save_dataset_info(OUTPUT_DIR, color_to_class, class_names, mean, std, class_counts, TARGET_SIZE)
