...
class Config:
    ...
    It supports Python config files (.py). The interface is the same as a dict 
    object and also allows access config values as attributes.
    ...
    Example:
        ...
        >>> cfg.b.b1
        [0, 1]
        >>> cfg = Config.fromfile('configs/camvid.py')
        >>> cfg.filename
        "configs/camvid.py"
    """
