...
class FCNs(nn.Module):
    """
    FCN with skip connections from all intermediate layers
    """
...
if __name__ == "__main__":
    batch_size, n_class, h, w = 1, 32, 480, 640

    # Test VGG16 FCN model
    fcn_model = create_fcn_model(n_class=n_class, backbone='vgg16', pretrained=False)
    ...
    print(f"✓ FCN model output shape: {output.shape}")
